                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/snap.png" alt="user_icon">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/onn.png" alt="user_icon">

                            </div> 

                            <h1><%=list.size()%></h1>
                            <h1 class="text-uppercase text-muted">Old & New</h1>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/lg.png" alt="user_icon">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card" data-toggle="modal" data-target="#add-category-modal">
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="container">
                                <img style="max-width: 125px;" class="img-fluid rounded-circle" src="img/addbook.png" alt="user_icon">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card" data-toggle="modal" data-target="#add-product-modal">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p class="mt-2">Click here to add new Book</p>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="ProductOperationServlet" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="pPic">Select Picture of Book</label>  
                                <br>
